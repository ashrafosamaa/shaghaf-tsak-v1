...
export const addRoom = async (req, res, next)=> {
    ...
    const {name, branch, description, seats, type, planId} = req.body
    // check planId
    ...
    const newRoom = { name, branch, description, seats, type, planId, coverImg, otherImgs, folderId }
...
export const getRoomById = async (req, res, next)=> {
    ...
    const room = await Room.findById(roomId).populate({path:"planId", select:"stamp price"})
...
export const updateRoom = async (req, res, next)=> {
    ...
    .populate({path:"planId", select:"stamp price"})
    .select("-createdAt -updatedAt -__v -folderId -coverImg.public_id -otherImgs.public_id")
    if (!roomUpdated) {
